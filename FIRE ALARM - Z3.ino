...
void setup() {
  ...
  LINE.notify("Z3 Ready..."); 
}

void loop() {

  // MeOH Z3 GND
  alarm_z3 = digitalRead(sensor5);
  if (alarm_z3 == 0){
  Serial.print("Z3: ");
  Serial.println(alarm_z3); 
  limit_time_z3 -= 1;
  if(limit_time_z3 == 0) {LINE.notify("Z3 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_z3/65 == repeat_alarm) {LINE.notify("(REPEAT) Z3 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
