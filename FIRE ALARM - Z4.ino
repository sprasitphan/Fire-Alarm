...
void setup() {
  ...
  LINE.notify("Z4 Ready..."); 
}

void loop() {

  // MeOH Z4 3V3
  alarm_z4 = digitalRead(sensor6);
  if (alarm_z4 == 0){
  Serial.print("Z4: ");
  Serial.println(alarm_z4); 
  limit_time_z4 -= 1;
  if(limit_time_z4 == 0) {LINE.notify("Z4 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_z4/65 == repeat_alarm) {LINE.notify("(REPEAT) Z4 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
