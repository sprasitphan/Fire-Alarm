...
void setup() {
  ...
  LINE.notify("Z1 Ready..."); 
}

void loop() {

  // MeOH Z1 GND
  alarm_z1 = digitalRead(sensor3);
  if (alarm_z1 == 0){
  Serial.print("Z1: ");
  Serial.println(alarm_z1); 
  limit_time_z1 -= 1;
  if(limit_time_z1 == 0) {LINE.notify("Z1 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_z1/65 == repeat_alarm) {LINE.notify("(REPEAT) Z1 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
