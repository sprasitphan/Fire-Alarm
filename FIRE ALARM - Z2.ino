...
void setup() {
  ...
  LINE.notify("Z2 Ready..."); 
}

void loop() {

  // MeOH Z2 GND
  alarm_z2 = digitalRead(sensor4);
  if (alarm_z2 == 0){
  Serial.print("Z2: ");
  Serial.println(alarm_z2); 
  limit_time_z2 -= 1;
  if(limit_time_z2 == 0) {LINE.notify("Z2 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_z2/65 == repeat_alarm) {LINE.notify("(REPEAT) Z2 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
