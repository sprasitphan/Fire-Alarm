...
void setup() {
  ...
  LINE.notify("ZS2 Ready..."); 
}

void loop() {

  // MeOH ZS2 GND
  alarm_zs2 = digitalRead(sensor1);
  if (alarm_zs2 == 0){
  Serial.print("ZS1: ");
  Serial.println(alarm_zs2); 
  limit_time_zs2 -= 1;
  if(limit_time_zs2 == 0) {LINE.notify("ZS2 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_zs2/65 == repeat_alarm) {LINE.notify("(REPEAT) ZS2 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
