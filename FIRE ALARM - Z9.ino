...
void setup() {
  ...
  LINE.notify("Z9 Ready..."); 
}

void loop() {

  // MeOH Z9 GND
  alarm_z9 = digitalRead(sensor7);
  if (alarm_z9 == 0){
  Serial.print("Z9: ");
  Serial.println(alarm_z9); 
  limit_time_z9 -= 1;
  if(limit_time_z9 == 0) {LINE.notify("Z9 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif");}
  Serial.print("REPEAT ALARM: ");
  Serial.println(repeat_alarm);
  if(limit_time_z9/65 == repeat_alarm) {LINE.notify("(REPEAT) Z9 - Internal room1"); LINE.notifyPicture("https://media.tenor.com/bH5qXUAuk4kAAAAC/fire.gif"); repeat_alarm--;}
  }
